...
public class MapperPersonajeTest extends MappersHelp {
    ...
    MapperPersonaje mapperPersonaje;

    @Test
    public void personajeEntityToPersonajeDTOTest(){
        personajeDTOMapper = mapperPersonaje.personajeEntityToPersonajeDTO(personaje);
    ...
    public void personajeDTOToPersonajeEntityTest(){
        personajeMapper = mapperPersonaje.personajeDTOToPersonajeEntity(personajeDTO);
