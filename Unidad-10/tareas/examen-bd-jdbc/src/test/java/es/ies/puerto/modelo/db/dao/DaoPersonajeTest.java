...
public class DaoPersonajeTest {
    ...
    @Test
    public void findPersonajeAliasEquipamientoPoder() throws MarvelException{
        Personaje personajeBuscar = daoPersonaje.findPersonaje(Personaje);
        Assertions.assertEquals(personajeBuscar.getId(), Personaje.getId());
        Assertions.assertEquals(personajeBuscar.getNombre(), Personaje.getNombre());
        Assertions.assertEquals(personajeBuscar.getGenero(), Personaje.getGenero());
    }
